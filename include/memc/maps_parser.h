...
public:
     ...
     */
    static std::vector<MemoryRegion> parse_from_string(const std::string& content);
...
private:
     ...
     */
    static RegionType classify_region(const std::string& pathname, const std::string& permissions);
};
